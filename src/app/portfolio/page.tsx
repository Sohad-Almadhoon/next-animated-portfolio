...
const items = [
  ...
  },
  {
    ...
    title: "Fiverr",
    desc: `A Fiverr clone built with Express.js and Mongoose offers freelance service browsing, order placement, and profile management. It features secure payment processing and messaging for smooth buyer-seller communication. Future updates will focus on performance optimization and new features based on user feedback.`,
    img: "/portfolio/5.png",
